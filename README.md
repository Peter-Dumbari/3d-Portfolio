...
```sh
  ...
  git clone https://github.com/Peter-Dumbari/3d-Portfolio.git
```
...
I would like to thank myself for the great effort put in delivering this project, also to Microverse.
